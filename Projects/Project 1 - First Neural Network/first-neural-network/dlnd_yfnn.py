...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        for X, y in zip(features, targets):
            ...
            ### Forward pass ###
            hidden_outputs, final_outputs = self.run(X, ret_all=True)
            ...
            output_error_term = error * 1  # gradient of x
    ...
    def run(self, features, ret_all=False):
